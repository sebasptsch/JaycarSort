/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/worker-configuration.d.ts` (hash: c4daba663babcda66a92b2ccc1bf99f2)
...
declare namespace Cloudflare {
	...
	interface Env {
		WEBSOCKET_HIBERNATION_SERVER: DurableObjectNamespace<import("./index").WebSocketHibernationServer>;
	}
}
